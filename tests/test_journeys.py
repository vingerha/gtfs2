...
not how the code says it, so they survive a rewrite of the query.
    ...
    pytest tests/test_journeys.py
    pytest tests/test_journeys.py -k "palmbus and 21"
"""
...
import fixture_db
from custom_components.gtfs2.gtfs_helper import get_next_departure, get_stop_list
...
def _repair_directions(schedule):
    ...
    """
    try:
        from custom_components.gtfs2 import direction_repair
    except ImportError:
        return None
    return direction_repair.repair_trip_directions(schedule)

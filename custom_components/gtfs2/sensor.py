...
def get_next_departure(
    ...
    _LOGGER.debug("Timetable Remaining: %s", timetable_remaining)    
...
class GTFSDepartureSensor(SensorEntity):
    ...
    def update(self) -> None:
        ...
        with self.lock:
            ...
            if not self._departure:
                ...
                _LOGGER.debug("Self Next Departures %s", self._next_departures)                
    ...
    def update_attributes(self) -> None:
        ...
        _LOGGER.debug("Next Dept %s", self._departure["next_departures"])
        # Add next departures

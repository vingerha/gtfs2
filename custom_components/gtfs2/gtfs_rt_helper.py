...
def get_next_services(self):
    self._stop = str(self._stop_id)
    self._destination = str(self._destination_id)
    self._route = str(self._route_id)
    self._trip = str(self._trip_id)
    self._direction = str(self._direction)
...
def get_gtfs_rt(hass, path, data):
    ...
    _stop_id = data.get('stop_id',None)
        ...
        entity_dict = {
            ...
            "trip_update": {
                "trip": {
                    ...
                    "direction_id": entity['MonitoredVehicleJourney']['DirectionRef']
                },
                "stop_time_update": [{
                    "stop_sequence": "n.a",
                    "stop_id": stop_id,
